const currenciesLookup = [
    ...
    { name: "Bosnia-Herzegovina Convertible Marka", code: "BAM" },
    ...
    { name: "Chilean Unit of Account (UF)", code: "CLF" },
    { name: "Chinese Yuan", code: "CNY" },
    { name: "Chinese Yuan (Offshore)", code: "CNH" },
    ...
    { name: "Mauritanian Ouguiya (1973–2017)", code: "MRO" },
    ...
    { name: "São Tomé & Príncipe Dobra", code: "STN" },
    { name: "Saudi Riyal", code: "SAR" },
    { name: "Senegalese Franc", code: "XOF" },
